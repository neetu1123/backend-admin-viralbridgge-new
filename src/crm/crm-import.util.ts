...
export function normalizeImportRow(raw: Record<string, string>): Record<string, string> {
...
export function validateImportRow(row: Record<string, string>, rowNumber: number) {
  const errors: string[] = [];
...
export const EXPORT_FIELD_MAP: Record<string, (l: Record<string, unknown>) => string> = {
